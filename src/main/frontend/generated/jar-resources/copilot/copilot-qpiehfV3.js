...
}, Ro = process.env.NODE_ENV !== "production" ? Vo : {};
function h(e) {
...
var jo = {};
function Hn() {
  return typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : jo;
}
var ri = Object.assign, zt = Object.getOwnPropertyDescriptor, Z = Object.defineProperty, en = Object.prototype, Ut = [];
Object.freeze(Ut);
var Kn = {};
Object.freeze(Kn);
var Mo = typeof Proxy < "u", Lo = /* @__PURE__ */ Object.toString();
function ii() {
  Mo || h(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
function tt(e) {
...
function P(e) {
  ...
  return typeof n == "function" && n.toString() === Lo;
}
function oi(e) {
  var t = e?.constructor;
...
var si = typeof Object.getOwnPropertySymbols < "u";
function Uo(e) {
  var t = Object.keys(e);
  if (!si)
    return t;
  ...
  return n.length ? [].concat(t, n.filter(function(r) {
    return en.propertyIsEnumerable.call(e, r);
  })) : t;
}
var pt = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : si ? function(e) {
...
var Bo = Object.getOwnPropertyDescriptors || function(t) {
  var n = {};
...
function Je(e, t, n) {
  return t && Fo(e.prototype, t), Object.defineProperty(e, "prototype", {
    writable: !1
  }), e;
}
function ze(e, t) {
...
function Ot(e, t, n) {
  if (H(e, ie) || nn(e, ie, he({}, e[ie])), process.env.NODE_ENV !== "production" && Bt(n) && !H(e[ie], t)) {
  ...
  Wo(e, n, t), Bt(n) || (e[ie][t] = n);
}
function Wo(e, t, n) {
  if (process.env.NODE_ENV !== "production" && !Bt(t) && H(e[ie], n)) {
...
ge.diffValueMask_ = 4;
var Wn = /* @__PURE__ */ Te("Atom", ge);
function ui(e, t, n) {
  t === void 0 && (t = Le), n === void 0 && (n = Le);
  var r = new ge(e);
  return t !== Le && rs(r, t), n !== Le && Vi(r, n), r;
}
function Go(e, t) {
  return Wi(e, t);
}
...
function Ne(e, t, n) {
  return bt(e) ? e : Array.isArray(e) ? S.array(e, {
    ...
    name: n
  }) : typeof e == "function" && !Fe(e) && !mt(e) ? oi(e) ? He(e) : gt(n, e) : e;
}
function Xo(e, t, n) {
  if (e == null || Ze(e) || dn(e) || me(e) || X(e))
    return e;
  if (Array.isArray(e))
    return S.array(e, {
      name: n,
...
function Yo(e, t) {
  return process.env.NODE_ENV !== "production" && bt(e) && h("observable.struct should not be used with observable values"), Wi(e, t) ? t : e;
}
var Zo = "override";
function Bt(e) {
...
function ta(e, t) {
  process.env.NODE_ENV !== "production" && rn(t, ["method", "field"]);
...
function di(e, t, n, r, i) {
  var o, a, s, l, c, u, d;
  i === void 0 && (i = f.safeDescriptors), na(e, t, n, r);
  var v = r.value;
...
function ra(e, t, n, r) {
  ...
  if (mt(n.value))
    return 1;
  var o = hi(e, this, t, n, !1, !1);
  return Z(r, t, o), 2;
}
function ia(e, t, n, r) {
  var i, o = hi(e, this, t, n, (i = this.options_) == null ? void 0 : i.bound);
  return e.defineProperty_(t, o, r);
}
function oa(e, t) {
  var n;
  process.env.NODE_ENV !== "production" && rn(t, ["method"]);
...
function hi(e, t, n, r, i, o) {
  o === void 0 && (o = f.safeDescriptors), aa(e, t, n, r);
  var a = r.value;
  if (mt(a) || (a = He(a)), i) {
    var s;
...
function la(e, t, n, r) {
  return ua(e, this, t, n), e.defineComputedProperty_(t, he({}, this.options_, {
    get: n.get,
    set: n.set
  }), r);
}
function ca(e, t) {
  process.env.NODE_ENV !== "production" && rn(t, ["getter"]);
...
function fa(e, t, n, r) {
  var i, o;
  return va(e, this, t, n), e.defineObservableProperty_(t, n.value, (i = (o = this.options_) == null ? void 0 : o.enhancer) != null ? i : Ne, r);
}
function ha(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
...
var ya = "observable", wa = "observable.ref", Ea = "observable.shallow", Oa = "observable.struct", pi = {
  deep: !0,
  name: void 0,
...
var $n = /* @__PURE__ */ an(ya), Aa = /* @__PURE__ */ an(wa, {
  enhancer: on
}), Sa = /* @__PURE__ */ an(Ea, {
  enhancer: Xo
}), xa = /* @__PURE__ */ an(Oa, {
...
function $t(e) {
  return e.deep === !0 ? Ne : e.deep === !1 ? on : Ca(e.defaultDecorator);
}
function Na(e) {
  var t;
  return e ? (t = e.defaultDecorator) != null ? t : vi(e) : void 0;
}
function Ca(e) {
  var t, n;
...
var Pa = {
  ...
  array: function(t, n) {
    var r = Pt(n);
    return (f.useProxies === !1 || r.proxy === !1 ? Ss : ps)(t, $t(r), r.name);
  },
  map: function(t, n) {
    var r = Pt(n);
    return new Ui(t, $t(r), r.name);
  },
  set: function(t, n) {
    var r = Pt(n);
  ...
  object: function(t, n, r) {
    return Ie(function() {
      return ji(f.useProxies === !1 || r?.proxy === !1 ? Ye({}, r) : fs({}, r), t, n);
    });
  },
  ref: /* @__PURE__ */ Q(Aa),
  shallow: /* @__PURE__ */ Q(Sa),
  deep: gi,
  struct: /* @__PURE__ */ Q(xa)
}, S = /* @__PURE__ */ ri(mi, Pa), bi = "computed", $a = "computed.struct", Dn = /* @__PURE__ */ Gn(bi), Da = /* @__PURE__ */ Gn($a, {
...
Object.assign(sn, Dn);
sn.struct = /* @__PURE__ */ Q(Da);
var sr, lr, Ft = 0, Ta = 1, ka = (sr = (lr = /* @__PURE__ */ zt(function() {
}, "name")) == null ? void 0 : lr.configurable) != null ? sr : !1, cr = {
  value: "action",
  configurable: !0,
  writable: !1,
  enumerable: !1
...
function Ia(e, t, n, r) {
  ...
  return Ft = d.actionId_, d;
}
function Va(e) {
  Ft !== e.actionId_ && h(30), Ft = e.parentActionId_, e.error_ !== void 0 && (f.suppressReactionErrors = !0), cn(e.prevAllowStateChanges_), dt(e.prevAllowStateReads_), L(), e.runAsAction_ && ae(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && I({
...
var ja = "create", Se = /* @__PURE__ */ function(e) {
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.observers_.size === 0 && !this.keepAlive_)
      Tn(this) && (this.warnAboutUntrackedRead_(), M(), this.value_ = this.computeValue_(!1), L());
    else if (Si(this), Tn(this)) {
      var r = f.trackingContext;
      this.keepAlive_ && !r && (f.trackingContext = this), this.trackAndCompute() && Ba(this), f.trackingContext = r;
    }
    var i = this.value_;
    if (Rt(i))
      throw i.cause;
    ...
    var r = this.value_, i = (
      /* see #1208 */
      this.dependenciesState_ === _.NOT_TRACKING_
    ), o = this.computeValue_(!0), a = i || Rt(r) || Rt(o) || !this.equals_(r, o);
    ...
    var i = ln(!1), o;
    if (r)
      o = yi(this, this.derivation, this.scope_);
    ...
    return cn(i), this.isComputing = !1, o;
  }, t.suspend_ = function() {
    this.keepAlive_ || (kn(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== z.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
...
U.diffValueMask_ = 16;
var un = /* @__PURE__ */ Te("ComputedValue", U), _;
(function(e) {
...
function Tn(e) {
  switch (e.dependenciesState_) {
    ...
    case _.POSSIBLY_STALE_: {
      for (var t = Jn(!0), n = ke(), r = e.observing_, i = r.length, o = 0; o < i; o++) {
        var a = r[o];
        if (un(a)) {
...
function yi(e, t, n) {
  var r = Jn(!0);
  Ei(e), e.newObserving_ = new Array(
  ...
  return f.inBatch--, f.trackingDerivation = i, za(e), La(e), dt(r), o;
}
function La(e) {
...
function za(e) {
  ...
  for (n.length = i, e.newObserving_ = null, o = t.length; o--; ) {
    var l = t[o];
    l.diffValue === 0 && Oi(l, e), l.diffValue = 0;
  }
  for (; i--; ) {
    var c = n[i];
...
}, mn = !0, f = /* @__PURE__ */ function() {
  var e = /* @__PURE__ */ Hn();
  return e.__mobxInstanceCount > 0 && !e.__mobxGlobals && (mn = !1), e.__mobxGlobals && e.__mobxGlobals.version !== new gn().version && (mn = !1), mn ? e.__mobxGlobals ? (e.__mobxInstanceCount += 1, e.__mobxGlobals.UNCHANGED || (e.__mobxGlobals.UNCHANGED = {}), e.__mobxGlobals) : (e.__mobxInstanceCount = 1, e.__mobxGlobals = /* @__PURE__ */ new gn()) : (setTimeout(function() {
    h(35);
  }, 1), new gn());
}();
function Ua(e, t) {
...
function Oi(e, t) {
  e.observers_.delete(t), e.observers_.size === 0 && Ai(e);
}
function Ai(e) {
...
function Si(e) {
  ...
  return t !== null ? (t.runId_ !== e.lastAccessedBy_ && (e.lastAccessedBy_ = t.runId_, t.newObserving_[t.unboundDepsCount_++] = e, !e.isBeingObserved && f.trackingContext && (e.isBeingObserved = !0, e.onBO())), e.isBeingObserved) : (e.observers_.size === 0 && f.inBatch > 0 && Ai(e), !1);
}
function xi(e) {
  e.lowestObserverState_ !== _.STALE_ && (e.lowestObserverState_ = _.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === _.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && t.isTracing_ !== z.NONE && Ni(t, e), t.onBecomeStale_()), t.dependenciesState_ = _.STALE_;
  }));
}
function Ba(e) {
  e.lowestObserverState_ !== _.STALE_ && (e.lowestObserverState_ = _.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === _.POSSIBLY_STALE_ ? (t.dependenciesState_ = _.STALE_, process.env.NODE_ENV !== "production" && t.isTracing_ !== z.NONE && Ni(t, e)) : t.dependenciesState_ === _.UP_TO_DATE_ && (e.lowestObserverState_ = _.UP_TO_DATE_);
  }));
}
function Fa(e) {
...
function Ni(e, t) {
  if (console.log("[mobx.trace] '" + e.name_ + "' is invalidated due to a change in: '" + t.name_ + "'"), e.isTracing_ === z.BREAK) {
    var n = [];
    Ci(is(e), n, 1), new Function(`debugger;
/*
Tracing '` + e.name_ + `'
...
var ee = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.isScheduled || (this.isScheduled = !0, f.pendingReactions.push(this), Pi());
    ...
    if (!this.isDisposed) {
      ...
      var s = yi(this, r, void 0);
      f.trackingContext = a, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && kn(this), Rt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && i && I({
        time: Date.now() - o
      }), L();
    }
    ...
    this.isDisposed || (this.isDisposed = !0, this.isRunning || (M(), kn(this), L()));
...
var ur = 100, Ka = function(t) {
  return t();
};
function Pi() {
  f.inBatch > 0 || f.isRunningReactions || Ka(qa);
}
function qa() {
  f.isRunningReactions = !0;
  for (var e = f.pendingReactions, t = 0; e.length > 0; ) {
    ++t === ur && (console.error(process.env.NODE_ENV !== "production" ? "Reaction doesn't converge to a stable state after " + ur + " iterations." + (" Probably there is a cycle in the reactive function: " + e[0]) : "[mobx] cycle in reaction: " + e[0]), e.splice(0));
    for (var n = e.splice(0), r = 0, i = n.length; r < i; r++)
      n[r].runReaction_();
  }
  f.isRunningReactions = !1;
}
var Kt = /* @__PURE__ */ Te("Reaction", ee);
function C() {
...
function Ga(e) {
  ...
  }) : (f.spyListeners.push(e), qn(function() {
    f.spyListeners = f.spyListeners.filter(function(t) {
      return t !== e;
    });
  }));
}
var Xn = "action", Ja = "action.bound", $i = "autoAction", Xa = "autoAction.bound", Di = "<unnamed action>", In = /* @__PURE__ */ St(Xn), Ya = /* @__PURE__ */ St(Ja, {
  bound: !0
}), Vn = /* @__PURE__ */ St($i, {
  autoAction: !0
}), Za = /* @__PURE__ */ St(Xa, {
...
function Ti(e) {
  var t = function(r, i) {
    if (A(r))
      return Ce(r.name || Di, r, e);
    if (A(i))
      return Ce(r, i, e);
    if (At(i))
      return (e ? Vn : In).decorate_20223_(r, i);
    if (xe(i))
      return Ot(r, i, e ? Vn : In);
    if (xe(r))
      return Q(St(e ? $i : Xn, {
        name: r,
        autoAction: e
...
var Oe = /* @__PURE__ */ Ti(!1);
Object.assign(Oe, In);
var gt = /* @__PURE__ */ Ti(!0);
Object.assign(gt, Vn);
Oe.bound = /* @__PURE__ */ Q(Ya);
gt.bound = /* @__PURE__ */ Q(Za);
function nu(e) {
  return _i(e.name || Di, !1, e, this, void 0);
}
function Fe(e) {
...
function ki(e, t) {
  var n, r, i, o;
  t === void 0 && (t = Kn), process.env.NODE_ENV !== "production" && (A(e) || h("Autorun expects a function as first argument"), Fe(e) && h("Autorun does not accept actions since actions are untrackable"));
...
function Yn(e, t, n) {
  var r, i, o;
  n === void 0 && (n = Kn), process.env.NODE_ENV !== "production" && ((!A(e) || !A(t)) && h("First and second argument to reaction should be functions"), P(n) || h("Third argument of reactions should be an object"));
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction", s = Oe(a, n.onError ? es(n.onError, t) : t), l = !n.scheduler && !n.delay, c = Ii(n), u = !0, d = !1, v, p = n.compareStructural ? Be.structural : n.equals || Be.default, b = new ee(a, function() {
    u || l ? E() : d || (d = !0, c(E));
...
function Mi(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = os(e.observing_).map(Mi)), t;
}
function os(e) {
...
Li.prototype = /* @__PURE__ */ Object.create(Error.prototype);
var bn = /* @__PURE__ */ fi("flow"), ss = /* @__PURE__ */ fi("flow.bound", {
  bound: !0
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var s = this, l = arguments, c = ++as, u = Oe(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0, p = new Promise(function(b, E) {
      var x = 0;
      d = E;
      function G($) {
        v = void 0;
...
function ls(e, t) {
  return e ? Ze(e) || !!e[m] || Wn(e) || Kt(e) || un(e) : !1;
}
function bt(e) {
  return process.env.NODE_ENV !== "production" && arguments.length !== 1 && h("isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property"), ls(e);
}
function cs() {
  if (process.env.NODE_ENV !== "production") {
...
function fs(e, t) {
  var n, r;
  return ii(), e = Ye(e, t), (r = (n = e[m]).proxy_) != null ? r : n.proxy_ = new Proxy(e, ds);
}
function R(e) {
...
var _n = /* @__PURE__ */ Symbol("mobx-keys");
function Xe(e, t, n) {
  return process.env.NODE_ENV !== "production" && (!P(e) && !P(Object.getPrototypeOf(e)) && h("'makeAutoObservable' can only be used for classes that don't have a superclass"), Ze(e) && h("makeAutoObservable can only be used on objects not already made observable")), P(e) ? ji(e, e, t, n) : (Ie(function() {
    var r = Ye(e, n)[m];
    if (!e[_n]) {
      var i = Object.getPrototypeOf(e), o = new Set([].concat(pt(e), pt(i)));
      o.delete("constructor"), o.delete(m), nn(i, _n, o);
    }
    e[_n].forEach(function(a) {
      return r.make_(
        a,
        // must pass "undefined" for { key: undefined }
        t && a in t ? t[a] : !0
...
var fr = "splice", F = "update", hs = 1e4, vs = {
  get: function(t, n) {
    var r = t[m];
    return n === m ? r : n === "length" ? r.getArrayLength_() : typeof n == "string" && !isNaN(n) ? r.get_(parseInt(n)) : H(qt, n) ? qt[n] : t[n];
  },
  set: function(t, n, r) {
    var i = t[m];
  ...
  return t.dehanceValue_ = function(r) {
    ...
    r !== this.lastKnownLength_ && h(16), this.lastKnownLength_ += i, this.legacyMode_ && i > 0 && Ki(r + i + 1);
  }, t.spliceWithArray_ = function(r, i, o) {
    var a = this;
    Y(this.atom_);
    var s = this.values_.length;
    if (r === void 0 ? r = 0 : r > s ? r = s : r < 0 && (r = Math.max(0, s + r)), arguments.length === 1 ? i = s - r : i == null ? i = 0 : i = Math.max(0, Math.min(i, s - r)), o === void 0 && (o = Ut), R(this)) {
      var l = j(this, {
        object: this.proxy_,
        type: fr,
        index: r,
...
function ps(e, t, n, r) {
  return n === void 0 && (n = process.env.NODE_ENV !== "production" ? "ObservableArray@" + B() : "ObservableArray"), r === void 0 && (r = !1), ii(), Ie(function() {
    var i = new Zn(n, t, r, !1);
    ai(i.values_, m, i);
    var o = new Proxy(i.values_, vs);
...
var gs = /* @__PURE__ */ Te("ObservableArrayAdministration", Zn);
function dn(e) {
  return tn(e) && gs(e[m]);
}
var ms = {}, de = "add", Wt = "delete", Ui = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ne), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + B() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[m] = ms, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, A(Map) || h(18), Ie(function() {
      o.keysAtom_ = ui(process.env.NODE_ENV !== "production" ? o.name_ + ".keys()" : "ObservableMap.keys()"), o.data_ = /* @__PURE__ */ new Map(), o.hasMap_ = /* @__PURE__ */ new Map(), n && o.merge(n);
    });
  }
  var t = e.prototype;
  return t.has_ = function(r) {
    ...
    if (!o) {
      var a = o = new Se(this.has_(r), on, process.env.NODE_ENV !== "production" ? this.name_ + "." + Cn(r) + "?" : "ObservableMap.key?", !1);
      this.hasMap_.set(r, a), Vi(a, function() {
    ...
    return me(r) && (r = new Map(r)), oe(function() {
      P(r) ? Uo(r).forEach(function(o) {
        return i.set(o, r[o]);
      }) : Array.isArray(r) ? r.forEach(function(o) {
        var a = o[0], s = o[1];
        return i.set(a, s);
      }) : Ge(r) ? (zo(r) || h(19, r), r.forEach(function(o, a) {
        return i.set(a, o);
      })) : r != null && h(20, r);
    }), this;
  }, t.clear = function() {
    ...
    var i = this;
    return oe(function() {
      for (var o = bs(r), a = /* @__PURE__ */ new Map(), s = !1, l = ze(i.data_.keys()), c; !(c = l()).done; ) {
        var u = c.value;
        if (!o.has(u)) {
          var d = i.delete(u);
          if (d)
      ...
      if (!s)
        if (i.data_.size !== a.size)
          ...
          for (var $ = i.data_.keys(), ce = a.keys(), be = $.next(), or = ce.next(); !be.done; ) {
            if (be.value !== or.value) {
              i.keysAtom_.reportChanged();
              break;
            }
            be = $.next(), or = ce.next();
...
}(), me = /* @__PURE__ */ Te("ObservableMap", Ui);
function hr(e) {
  return e[Symbol.toStringTag] = "MapIterator", er(e);
}
function bs(e) {
  if (Ge(e) || me(e))
    return e;
...
var _s = {}, Bi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ne), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + B() : "ObservableSet"), this.name_ = void 0, this[m] = _s, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, A(Set) || h(22), this.enhancer_ = function(a, s) {
      return r(a, s, i);
    }, Ie(function() {
      o.atom_ = ui(o.name_), n && o.replace(n);
    });
  }
  var t = e.prototype;
  return t.dehanceValue_ = function(r) {
...
}(), X = /* @__PURE__ */ Te("ObservableSet", Bi);
function vr(e) {
  return e[Symbol.toStringTag] = "SetIterator", er(e);
}
var pr = /* @__PURE__ */ Object.create(null), gr = "remove", Rn = /* @__PURE__ */ function() {
  function e(n, r, i, o) {
    r === void 0 && (r = /* @__PURE__ */ new Map()), o === void 0 && (o = ga), this.target_ = void 0, this.values_ = void 0, this.name_ = void 0, this.defaultAnnotation_ = void 0, this.keysAtom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.proxy_ = void 0, this.isPlainObject_ = void 0, this.appliedAnnotations_ = void 0, this.pendingKeys_ = void 0, this.target_ = n, this.values_ = r, this.name_ = i, this.defaultAnnotation_ = o, this.keysAtom_ = new ge(process.env.NODE_ENV !== "production" ? this.name_ + ".keys" : "ObservableObject.keys"), this.isPlainObject_ = P(this.target_), process.env.NODE_ENV !== "production" && !Gi(this.defaultAnnotation_) && h("defaultAnnotation must be valid annotation"), process.env.NODE_ENV !== "production" && (this.appliedAnnotations_ = {});
  }
  var t = e.prototype;
  return t.getObservablePropValue_ = function(r) {
    ...
    return i || (i = new Se(r in this.target_, on, process.env.NODE_ENV !== "production" ? this.name_ + "." + Cn(r) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(r, i)), i.get();
  }, t.make_ = function(r, i) {
    if (i === !0 && (i = this.defaultAnnotation_), i !== !1) {
      if (_r(this, i, r), !(r in this.target_)) {
        var o;
        if ((o = this.target_[ie]) != null && o[r])
          return;
        h(1, i.annotationType_, this.name_ + "." + r.toString());
      }
      for (var a = this.target_; a && a !== en; ) {
        var s = zt(a, r);
        if (s) {
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[r], c && (this.values_.delete(r), c instanceof Se && (u = c.value_), xi(c)), this.keysAtom_.reportChanged(), (a = this.pendingKeys_) == null || (a = a.get(r)) == null || a.set(r in this.target_), s || l) {
        var v = {
          type: gr,
          observableKind: "object",
          object: this.proxy_ || this.target_,
...
function Ye(e, t) {
  ...
  if (process.env.NODE_ENV !== "production" && t && Ze(e) && h("Options can't be provided for already observable objects."), H(e, m))
    return process.env.NODE_ENV !== "production" && !(qi(e) instanceof Rn) && h("Cannot convert '" + Gt(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
  ...
  var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (P(e) ? "ObservableObject" : e.constructor.name) + "@" + B() : "ObservableObject", i = new Rn(e, /* @__PURE__ */ new Map(), String(r), Na(t));
  return nn(e, m, i), e;
}
var ys = /* @__PURE__ */ Te("ObservableObjectAdministration", Rn);
function mr(e) {
  return pr[e] || (pr[e] = {
    get: function() {
...
function _r(e, t, n) {
  if (process.env.NODE_ENV !== "production" && !Gi(t) && h("Cannot annotate '" + e.name_ + "." + n.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Bt(t) && H(e.appliedAnnotations_, n)) {
...
var ws = /* @__PURE__ */ Hi(0), Es = /* @__PURE__ */ function() {
  var e = !1, t = {};
...
var Qn = /* @__PURE__ */ function(e) {
  function t(r, i, o, a) {
    ...
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableArray@" + B() : "ObservableArray"), a === void 0 && (a = !1), s = e.call(this) || this, Ie(function() {
      ...
      l.proxy_ = s, ai(s, m, l), r && r.length && s.spliceWithArray(0, 0, r), Es && Object.defineProperty(s, "0", ws);
    }), s;
  }
  ci(t, e);
  var n = t.prototype;
...
function As(e) {
  Z(Qn.prototype, "" + e, Hi(e));
}
function Ki(e) {
  if (e > yn) {
    for (var t = yn; t < e + 100; t++)
      As(t);
    yn = e;
  }
}
...
function qi(e, t) {
  if (e || h(29), Wn(e) || un(e) || Kt(e) || me(e) || X(e))
    return e;
  if (e[m])
    return e[m];
  h(24, e);
...
function wr(e) {
  return dn(e) ? e.slice() : Ge(e) || me(e) || re(e) || X(e) ? Array.from(e.entries()) : e;
}
var Er, xs = ((Er = Hn().Iterator) == null ? void 0 : Er.prototype) || {};
function er(e) {
  return e[Symbol.iterator] = Ns, Object.assign(Object.create(xs), e);
}
function Ns() {
  return this;
}
...
class fe {
  ...
  static persist(t) {
    sessionStorage.setItem(Or, JSON.stringify(t));
  }
...
const Cs = Symbol.for("react.portal"), Ps = Symbol.for("react.fragment"), $s = Symbol.for("react.strict_mode"), Ds = Symbol.for("react.profiler"), Ts = Symbol.for("react.provider"), ks = Symbol.for("react.context"), Ji = Symbol.for("react.forward_ref"), Is = Symbol.for("react.suspense"), Vs = Symbol.for("react.suspense_list"), Rs = Symbol.for("react.memo"), js = Symbol.for("react.lazy");
function Ms(e, t, n) {
...
function Jt(e) {
  ...
  if (typeof e == "object")
    switch (e.$$typeof) {
      ...
      case Ts:
        return `${Ar(e._context)}.Provider`;
      case Ji:
        return Ms(e, e.render, "ForwardRef");
      case Rs:
        const t = e.displayName || null;
        return t !== null ? t : Jt(e.type) || "Memo";
      case js: {
...
function ct(e) {
  const t = e.type;
  return t?.$$typeof === Ji && !t.displayName && e.child ? ct(e.child) : Jt(e.type) ?? Jt(e.elementType) ?? "???";
}
function Hs() {
  const e = Array.from(document.querySelectorAll("body > *")).flatMap((n) => n[Fs()]).find((n) => n), t = $e(e);
  return $e(t?.child);
}
function Ks(e) {
  const t = [];
...
function Gs(e) {
  return typeof e.type != "function" || Yi(e) ? !1 : !!(Xt(e) || zs(e));
}
function Yi(e) {
  if (!e)
    return !1;
...
const fn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), ve = "copilot-", Js = "24.7.1", iu = "attention-required", ou = "https://plugins.jetbrains.com/plugin/23758-vaadin", au = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function su(e) {
...
function hn(e) {
  Promise.resolve().then(() => ec).then(({ showNotification: t }) => {
    t(e);
  });
}
function el() {
...
function tl(e) {
  return e.children && (e.children = e.children.filter(tl)), e.visible !== !1;
}
async function to() {
  return Qi(() => {
...
const pu = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, il = (e) => {
  const t = [];
  let n = al(e);
  for (; n; )
...
function ul(e, t) {
  const n = ll(e), r = n.getBoundingClientRect();
...
function mu(e) {
  const t = no(e), n = ol(t);
  !t.every((i) => cl(i, n)) && t.length > 0 && t[0].scrollIntoView();
}
function no(e) {
  const t = e;
  if (!t)
  ...
  return t.children.flatMap((r) => no(r));
}
var ro = /* @__PURE__ */ ((e) => (e["vaadin-combo-box"] = "vaadin-combo-box", e["vaadin-date-picker"] = "vaadin-date-picker", e["vaadin-dialog"] = "vaadin-dialog", e["vaadin-multi-select-combo-box"] = "vaadin-multi-select-combo-box", e["vaadin-select"] = "vaadin-select", e["vaadin-time-picker"] = "vaadin-time-picker", e["vaadin-popover"] = "vaadin-popover", e))(ro || {});
const nt = {
  "vaadin-combo-box": {
    hideOnActivation: !0,
    open: (e) => Tt(e),
  ...
  "vaadin-select": {
    ...
    open: (e) => {
      const t = e;
      oo(t, t._overlayElement), t.opened = !0;
    },
    close: (e) => {
      const t = e;
      ao(t, t._overlayElement), t.opened = !1;
    }
  },
  ...
  e.addEventListener("focusout", io, { capture: !0 }), oo(e), e.opened = !0;
}, kt = (e) => {
  ao(e), e.removeAttribute("focused"), e.removeEventListener("focusout", io, { capture: !0 }), e.opened = !1;
}, oo = (e, t) => {
  const n = t ?? e.$.overlay;
...
class fl {
  ...
  overlayStatus(t) {
    if (!t)
      return { visible: !1 };
    const n = t.localName;
    let r = Object.keys(ro).includes(n);
    if (!r)
      return { visible: !1 };
...
class ml {
  constructor() {
    this.palette = { components: [] }, Xe(this), this.initializer = new so(), this.initializer.promise.then(() => {
      Yn(
        () => JSON.stringify(this),
        () => {
          te("copilot-set-project-state-configuration", { conf: JSON.stringify($r(this)) });
        }
      );
  ...
  addPaletteCustomComponent(t) {
    return (this.palette?.components ?? []).find((i) => En(i, t)) ? !1 : (this.palette || (this.palette = { components: [] }), this.palette = JSON.parse(JSON.stringify(this.palette)), this.palette.components.push(t), !0);
  }
  ...
  updatePaletteCustomComponent(t, n) {
    if (!this.palette || !this.palette.components)
      return;
    const r = [...this.palette.components], i = r.findIndex((o) => En(o, t));
...
window.Vaadin.copilot._uiState = new rl();
window.Vaadin.copilot.eventbus = new Io();
window.Vaadin.copilot.overlayManager = new fl();
window.Vaadin.copilot._machineState = new hl();
window.Vaadin.copilot._storedProjectState = new ml();
window.Vaadin.copilot._previewState = new vl();
window.Vaadin.copilot._sectionPanelUiState = new pl();
window.Vaadin.copilot._earlyProjectState = new gl();
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const jt = globalThis, tr = jt.ShadowRoot && (jt.ShadyCSS === void 0 || jt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, nr = Symbol(), Dr = /* @__PURE__ */ new WeakMap();
let lo = class {
  constructor(t, n, r) {
    if (this._$cssResult$ = !0, r !== nr) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (tr && t === void 0) {
      ...
      r && (t = Dr.get(n)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && Dr.set(n, t));
    }
    return t;
  }
  toString() {
...
const J = (e) => new lo(typeof e == "string" ? e : e + "", void 0, nr), _l = (e, ...t) => {
  const n = e.length === 1 ? e[0] : t.reduce((r, i, o) => r + ((a) => {
    if (a._$cssResult$ === !0) return a.cssText;
    if (typeof a == "number") return a;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + a + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(i) + e[o + 1], e[0]);
  return new lo(n, e, nr);
}, yl = (e, t) => {
  if (tr) e.adoptedStyleSheets = t.map((n) => n instanceof CSSStyleSheet ? n : n.styleSheet);
...
}, Tr = tr ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let n = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: wl, defineProperty: El, getOwnPropertyDescriptor: Ol, getOwnPropertyNames: Al, getOwnPropertySymbols: Sl, getPrototypeOf: xl } = Object, vn = globalThis, kr = vn.trustedTypes, Nl = kr ? kr.emptyScript : "", Cl = vn.reactiveElementPolyfillSupport, ft = (e, t) => e, zn = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Nl : null;
      break;
  ...
  return n;
} }, co = (e, t) => !wl(e, t), Ir = { attribute: !0, type: String, converter: zn, reflect: !1, hasChanged: co };
...
let Me = class extends HTMLElement {
  ...
  static createProperty(t, n = Ir) {
    if (n.state && (n.attribute = !1), this._$Ei(), this.elementProperties.set(t, n), !n.noAccessor) {
      ...
      i !== void 0 && El(this.prototype, t, i);
    }
  }
  static getPropertyDescriptor(t, n, r) {
    const { get: i, set: o } = Ol(this.prototype, t) ?? { get() {
      return this[n];
    }, set(a) {
      this[n] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ft("properties"))) {
      const n = this.properties, r = [...Al(n), ...Sl(n)];
  ...
  createRenderRoot() {
    ...
    return yl(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
  ...
  _$EC(t, n) {
    ...
    if (i !== void 0 && r.reflect === !0) {
      const o = (r.converter?.toAttribute !== void 0 ? r.converter : zn).toAttribute(n, r.type);
  ...
  _$AK(t, n) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const o = r.getPropertyOptions(i), a = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : zn;
      this._$Em = i, this[i] = a.fromAttribute(n, o.type), this._$Em = null;
    }
  }
  requestUpdate(t, n, r) {
    if (t !== void 0) {
      if (r ??= this.constructor.getPropertyOptions(t), !(r.hasChanged ?? co)(this[t], n)) return;
      this.P(t, n, r);
    }
...
Me.elementStyles = [], Me.shadowRootOptions = { mode: "open" }, Me[ft("elementProperties")] = /* @__PURE__ */ new Map(), Me[ft("finalized")] = /* @__PURE__ */ new Map(), Cl?.({ ReactiveElement: Me }), (vn.reactiveElementVersions ??= []).push("2.0.4");
const je = Symbol("LitMobxRenderReaction"), Vr = Symbol("LitMobxRequestUpdate");
function Pl(e, t) {
  var n, r;
  return r = class extends e {
    ...
    connectedCallback() {
      ...
      this[je] = new t(`${o}.update()`, this[Vr]), this.hasUpdated && this.requestUpdate();
    }
    disconnectedCallback() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rr = globalThis, Qt = rr.trustedTypes, Rr = Qt ? Qt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, uo = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, fo = "?" + ue, Dl = `<${fo}>`, De = document, yt = () => De.createComment(""), wt = (e) => e === null || typeof e != "object" && typeof e != "function", ir = Array.isArray, Tl = (e) => ir(e) || typeof e?.[Symbol.iterator] == "function", On = `[ 	
\f\r]`, rt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, jr = /-->/g, Mr = />/g, ye = RegExp(`>|${On}(?:([^\\s"'>=/]+)(${On}*=${On}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Lr = /'/g, zr = /"/g, ho = /^(?:script|style|textarea|title)$/i, vo = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), Ue = vo(1), wu = vo(2), pe = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Ur = /* @__PURE__ */ new WeakMap(), Ae = De.createTreeWalker(De, 129);
function po(e, t) {
...
const kl = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    const l = e[s];
    let c, u, d = -1, v = 0;
    for (; v < l.length && (a.lastIndex = v, u = a.exec(l), u !== null); ) v = a.lastIndex, a === rt ? u[1] === "!--" ? a = jr : u[1] !== void 0 ? a = Mr : u[2] !== void 0 ? (ho.test(u[2]) && (i = RegExp("</" + u[2], "g")), a = ye) : u[3] !== void 0 && (a = ye) : a === ye ? u[0] === ">" ? (a = i ?? rt, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? ye : u[3] === '"' ? zr : Lr) : a === zr || a === Lr ? a = ye : a === jr || a === Mr ? a = rt : (a = ye, i = void 0);
    const p = a === ye && e[s + 1].startsWith("/>") ? " " : "";
    o += a === rt ? l + Dl : d >= 0 ? (r.push(c), l.slice(0, d) + uo + l.slice(d) + ue + p) : l + ue + (d === -2 ? s : p);
  }
  return [po(e, o + (e[n] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class Et {
  constructor({ strings: t, _$litType$: n }, r) {
    ...
    for (; (i = Ae.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(uo)) {
          const v = u[a++], p = i.getAttribute(d).split(ue), b = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: o, name: b[2], strings: p, ctor: b[1] === "." ? Vl : b[1] === "?" ? Rl : b[1] === "@" ? jl : pn }), i.removeAttribute(d);
      ...
      } else if (i.nodeType === 8) if (i.data === fo) l.push({ type: 2, index: o });
      else {
        let d = -1;
...
let Il = class {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new Qe(o, o.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (c = new Ml(o, this, t)), this._$AV.push(c), l = r[++s];
      }
...
class Qe {
  ...
  _$AI(t, n = this) {
    t = We(this, t, n), wt(t) ? t === O || t == null || t === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : t !== this._$AH && t !== pe && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Tl(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: n, _$litType$: r } = t, i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Et.createElement(po(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === i) this._$AH.p(n);
    else {
      const o = new Il(i, this), a = o.u(this.options);
      o.p(n), this.T(a), this._$AH = o;
    }
  }
  _$AC(t) {
    let n = Ur.get(t.strings);
    return n === void 0 && Ur.set(t.strings, n = new Et(t)), n;
  }
  k(t) {
...
const Ll = { I: Qe }, zl = rr.litHtmlPolyfillSupport;
zl?.(Et, Qe), (rr.litHtmlVersions ??= []).push("3.2.1");
const Ul = (e, t, n) => {
...
let ht = class extends Me {
  ...
  update(t) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Ul(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const Bl = globalThis.litElementPolyfillSupport;
Bl?.({ LitElement: ht });
(globalThis.litElementVersions ??= []).push("4.1.1");
class Fl extends $l(ht) {
}
class Hl extends Fl {
  constructor() {
...
function Kl() {
  Ee.push(import("./copilot-log-plugin-BQI4b8gH.js")), Ee.push(import("./copilot-info-plugin-BSxS5_fN.js")), Ee.push(import("./copilot-features-plugin-vu78JZ26.js")), Ee.push(import("./copilot-feedback-plugin-BLKoxoNT.js")), Ee.push(import("./copilot-shortcuts-plugin-CcgvXyzo.js"));
}
function ql() {
  {
    const e = `https://cdn.vaadin.com/copilot/${Js}/copilot-plugins.js`;
    import(
      /* @vite-ignore */
      e
    ).catch((t) => {
...
function Wl() {
  Promise.all(Ee).then(() => {
    ...
    if (e.copilot.plugins) {
      ...
      e.copilot.plugins.push = (n) => Fr(n), Array.from(t).forEach((n) => {
        Br.includes(n) || (Fr(n), Br.push(n));
      });
    }
  }), Ee = [];
}
...
const It = new Gl(), y = window.Vaadin.copilot.eventbus;
if (!y)
  throw new Error("Tried to access copilot eventbus before it was initialized.");
const ot = window.Vaadin.copilot.overlayManager, Su = {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const go = { CHILD: 2, ELEMENT: 6 }, mo = (e) => (...t) => ({ _$litDirective$: e, values: t });
class bo {
  constructor(t) {
  }
  get _$AU() {
...
class Un extends bo {
  constructor(t) {
    if (super(t), this.it = O, t.type !== go.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
Un.directiveName = "unsafeHTML", Un.resultType = 1;
const Jl = mo(Un), Ct = window.Vaadin.copilot._machineState;
if (!Ct)
  throw new Error("Trying to use stored machine state before it was initialized");
const Xl = 5e3;
let Hr = 1;
function _o(e) {
  g.notifications.includes(e) && (e.dontShowAgain && e.dismissId && Yl(e.dismissId), g.removeNotification(e), y.emit("notification-dismissed", e));
}
function yo(e) {
  return Ct.getDismissedNotifications().includes(e);
}
function Yl(e) {
  yo(e) || Ct.addDismissedNotification(e);
}
function Zl(e) {
  return !(e.dismissId && (yo(e.dismissId) || g.notifications.find((t) => t.dismissId === e.dismissId)));
}
function wo(e) {
  Zl(e) && Ql(e);
}
function Ql(e) {
  ...
  g.setNotifications([...g.notifications, n]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    _o(n);
  }, e.delay ?? Xl), y.emit("notification-shown", e);
}
const ec = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  dismissNotification: _o,
  showNotification: wo
...
function nc() {
  fn(`${ve}plugin-restart-application`, {}, () => {
  }).catch((e) => {
    le("Error restarting server", e);
  });
}
const Eo = window.Vaadin.copilot._previewState;
if (!Eo)
  throw new Error("Tried to access copilot preview state before it was initialized.");
const rc = async () => Qi(() => g.userInfo), xu = async () => (await rc()).vaadiner;
function ic() {
  const e = g.userInfo;
...
}, ac = (e, t) => e.error ? (sc(e.error, t), !0) : !1, Oo = (e, t, n, r) => {
  hn({
    type: Ve.ERROR,
    message: e,
    details: eo(
      Ue`<vaadin-details summary="Details" style="color: var(--dev-tools-text-color)"
        ><div>
          <code class="codeblock" style="white-space: normal;color: var(--color)"
            ><copilot-copy></copilot-copy>${Jl(t)}</code
          >
    ...
    delay: 3e4
  }), ic() && y.emit("system-info-with-callback", {
...
function le(e, t) {
  const n = An(t) ? t.exceptionMessage ?? t.message : t, r = {
    type: Ve.ERROR,
    message: "Copilot internal error",
    details: e + (n ? `
${n}` : "")
  };
  An(t) && t.suggestRestart && tc() && (r.details = eo(
    Ue`${e}<br />${n}
        <button
          style="align-self:start;padding:0"
          @click=${(o) => {
      const a = o.target;
      a.disabled = !0, a.innerText = "Restarting...", nc();
    }}>
          Restart now
        </button>`
  ), r.delay = 3e4), hn(r);
  let i;
  t instanceof Error ? i = t.stack : An(t) ? i = t?.exceptionStacktrace?.join(`
...
function Ao() {
  ...
  Array.isArray(t) && Bn.push(...t), So((n) => Bn.push(n));
}
const Bn = [];
function So(e) {
  const t = window.Vaadin.ConsoleErrors;
  window.Vaadin.ConsoleErrors = {
    push: (n) => {
      n[0].type !== void 0 && n[0].message !== void 0 ? e({
        ...
        details: n[0].details,
        link: n[0].link
      }) : e({ type: Ve.ERROR, message: n.map((r) => cc(r)).join(" "), internal: !1 }), t.push(n);
    }
  };
}
function cc(e) {
...
const dc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  catchErrors: So,
  consoleErrorsQueue: Bn,
  handleBrowserOperationError: lc,
  handleCopilotError: le,
  handleErrorDuringOperation: oc,
  handleServerOperationErrorIfNeeded: ac,
  installErrorHandlers: Ao,
  showNotReactFlowProject: uc
}, Symbol.toStringTag, { value: "Module" })), xo = () => {
  fc().then((e) => g.setUserInfo(e)).catch((e) => le("Failed to load userInfo", e));
}, fc = async () => fn(`${ve}get-user-info`, {}, (e) => (delete e.data.reqId, e.data));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const No = Symbol.for(""), hc = (e) => {
  if (e?.r === No) return e?._$litStatic$;
}, Co = (e) => ({ _$litStatic$: e, r: No }), qr = /* @__PURE__ */ new Map(), vc = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], s = [];
  let l, c = 0, u = !1;
  for (; c < r; ) {
    for (l = t[c]; c < r && (o = n[c], (i = hc(o)) !== void 0); ) l += i + t[++c], u = !0;
    c !== r && s.push(o), a.push(l), c++;
  }
  if (c === r && a.push(t[r]), u) {
    const d = a.join("$$lit$$");
    (t = qr.get(d)) === void 0 && (a.raw = a, qr.set(d, t = a)), n = s;
  }
  return e(t, ...n);
}, vt = vc(Ue);
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: pc } = Ll, Nu = (e) => e.strings === void 0, Wr = () => document.createComment(""), at = (e, t, n) => {
  const r = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
  if (n === void 0) {
    const o = r.insertBefore(Wr(), i), a = r.insertBefore(Wr(), i);
    n = new pc(o, a, e, e.options);
  } else {
  ...
  return n;
}, we = (e, t, n = e) => (e._$AI(t, n), e), gc = {}, mc = (e, t = gc) => e._$AH = t, bc = (e) => e._$AH, Sn = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const Gr = (e, t, n) => {
  ...
  return r;
}, Po = mo(class extends bo {
  constructor(e) {
    if (super(e), e.type !== go.CHILD) throw Error("repeat() can only be used in text expressions");
  }
  dt(e, t, n) {
    let r;
  ...
  update(e, [t, n, r]) {
    const i = bc(e), { values: o, keys: a } = this.dt(t, n, r);
    ...
    else if (c === void 0 && (c = Gr(a, p, b), u = Gr(s, d, v)), c.has(s[d])) if (c.has(s[v])) {
    ...
    return this.ut = a, mc(e, l), pe;
  }
}), Mt = /* @__PURE__ */ new Map(), _c = (e) => {
...
let xn;
const Ec = new Uint8Array(16);
function Oc() {
  if (!xn) {
    if (typeof crypto > "u" || !crypto.getRandomValues)
      throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
    xn = crypto.getRandomValues.bind(crypto);
  }
  return xn(Ec);
}
const Ac = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Jr = { randomUUID: Ac };
function $o(e, t, n) {
  if (Jr.randomUUID && !e)
    return Jr.randomUUID();
  e = e || {};
  const r = e.random ?? e.rng?.() ?? Oc();
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, wc(r);
}
const Lt = [], ut = [], $u = async (e, t, n) => {
  let r, i;
  t.reqId = $o();
...
const Yr = new zc(), Uc = "copilot-development-setup-user-guide";
function ku() {
  _t("use-dev-workflow-guide"), se.updatePanel(Uc, { floating: !0 });
}
function ko() {
  const e = g.jdkInfo;
...
function Iu() {
  const e = g.jdkInfo;
  return !e || ko() !== "success" ? "none" : e.jrebel ? "jrebel" : e.runningWitHotswap ? "hotswap" : "none";
}
function Bc() {
...
class Hc {
  ...
  includeReactNode(t) {
    return ct(t) === "PreconfiguredAuthProvider" || ct(t) === "RouterProvider" ? !1 : Sr(t) || Gs(t);
  }
  async includeFlowNode(t) {
    return Zs(t) || wn(t)?.hiddenByServer ? !1 : this.isInitializedInProjectSources(t);
  }
  async isInitializedInProjectSources(t) {
    ...
    if (!this.flowNodesInSource[i]) {
      const o = await fn("copilot-get-component-source-info", { uiId: i }, (a) => a.data);
  ...
  async addToTree(t, n) {
    ...
    if (n)
      ...
      if (!o)
        return !(t instanceof Element) && Yi(t) ? (wo({
          type: Ve.WARNING,
    ...
    const a = o ?? n, s = i ? Array.from(t.children) : Ks(t);
    for (const l of s)
      await this.addToTree(l, a);
    return o !== void 0;
  }
  generateNodeFromFiber(t, n) {
    const r = Sr(t) ? Zt(t) : void 0, i = n?.children.length ?? 0;
    return {
      node: t,
      parent: n,
      element: r,
      ...
      get nameAndIdentifier() {
        return Qr(this.name, this.identifier);
      },
      get previousSibling() {
        if (i !== 0)
  ...
  generateNodeFromFlow(t, n) {
    ...
    return {
      ...
      isReactComponent: !1,
      get name() {
        return Xs(r) ?? Nr(r.element.localName);
      },
      get identifier() {
        return Cr(t);
      },
...
const Fn = (e) => {
  if (Ct.isActivationShortcut())
    if (e.key === "Shift" && !e.ctrlKey && !e.altKey && !e.metaKey)
      Nn = !0;
    else if (Nn && e.shiftKey && (e.key === "Control" || e.key === "Meta")) {
      if (lt++, lt === 2)
...
function Jc(e) {
  const t = Mn(e, "vaadin-context-menu-overlay");
  if (!t)
    return !1;
  const n = t.owner;
  return n ? !!Mn(n, "copilot-component-overlay") : !1;
}
function Xc() {
...
const ti = (e) => {
  ...
  let i = !0;
  ei(e) ? i = !1 : e.key === "Escape" ? g.loginCheckActive ? g.setLoginCheckActive(!1) : y.emit("close-drawers", {}) : Yc(e) ? y.emit("delete-selected", {}) : (e.ctrlKey || e.metaKey) && e.key === "d" ? y.emit("duplicate-selected", {}) : (e.ctrlKey || e.metaKey) && e.key === "b" ? y.emit("show-selected-in-ide", { attach: e.shiftKey }) : (e.ctrlKey || e.metaKey) && e.key === "z" && Xc() ? y.emit("undoRedo", { undo: !e.shiftKey }) : ei(e) || y.emit("keyboard-event", { event: e }), i && e.stopPropagation();
}, Yc = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, ne = Gc(), Ru = {
...
var Zc = Object.getOwnPropertyDescriptor, Qc = (e, t, n, r) => {
  for (var i = r > 1 ? void 0 : r ? Zc(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = a(i) || i);
  return i;
};
let ni = class extends Hl {
  constructor() {
    ...
    }, this.operationInProgressCursorUpdateDebounceFunc = Lc(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-ClbVQ9Id.js"), await import("./copilot-init-step2-D8mh2A2u.js"), nl(), Kl(), this.tabIndex = 0, It.hostConnectedCallback(), window.addEventListener("keydown", Fn), this.addEventListener("keydown", ti), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), fe.getCopilotActivation() && to().then(() => {
    ...
    ), Ao(), this.initialized = !0, Fc();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    It.activate(), Yr.copilotActivated(), Wl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.addEventListener("mouseover", this.mouseOverListener), ot.onCopilotActivation(), await Kc(), Eo.loadPreviewConfiguration(), this.active = !0;
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), It.deactivate(), Yr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.removeEventListener("mouseover", this.mouseOverListener), ot.onCopilotDeactivation(), this.active = !1;
  }
  disconnectedCallback() {
    super.disconnectedCallback(), It.hostDisconnectedCallback(), window.removeEventListener("keydown", Fn), this.removeEventListener("keydown", ti), y.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), ot.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
  ...
  render() {
    return Ue`
      ...
      ${this.renderDrawer("left")} ${this.renderDrawer("right")} ${this.renderDrawer("bottom")} ${yc()}
  ...
  closeDrawers() {
    ...
    const i = Mn(r, "copilot-drawer-panel");
    if (!i) {
      e.forEach((o) => {
        o.opened = !1;
      });
